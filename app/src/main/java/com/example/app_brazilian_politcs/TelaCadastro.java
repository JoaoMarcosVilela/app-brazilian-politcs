 ...
 * Use the {@link TelaCadastro#newInstance} factory method to
...
public class TelaCadastro extends Fragment {
    ...
    public static TelaCadastro newInstance(String param1, String param2) {
        TelaCadastro fragment = new TelaCadastro();
